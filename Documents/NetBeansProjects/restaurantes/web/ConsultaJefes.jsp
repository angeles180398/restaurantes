...
<table width="25%">
    <tr>
        <td colspan="2" align="center">
          <form action="agregarJ.html" method="get">
          <input type="submit" name="button" id="button" value="Agregar">
          </form>
      
      </td>
      <td colspan="2" align="center">
          <form action="editarJ.html" method="get">
          <input type="submit" name="button" id="button" value="Editar">
          </form>
      
      </td>
      <td colspan="2" align="center">
          <form action="borrarJ.html" method="get">
...
try
{
  ...
  Class.forName("com.mysql.jdbc.Driver");
            ...
            if (!miConexion.isClosed())
   {
      ...
      ResultSet rs = st.executeQuery("SELECT * FROM jefe");
